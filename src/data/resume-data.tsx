...
export const RESUME_DATA = {
  ...
  //
  about:
    "Меня зовут Гагик. Я студент на заочном обучении и ищу работу на позицию Frontend-разработчик в продуктовой компании или на аутсорсинг. В работе ценю хороший код и замечательных коллег. Мне также важно получить опыт, а трудности меня не пугают:) Буду рад знакомству!",
  ...
  education: [
    {
      ...
      link: "https://urfu.ru",
      degree: "Поступил на факультет Радиофак на бакалавра по специальности «Прикладная информатика». Начало учёбы началось с Java Core, но я настолько остался верен Frontend'у, что даже выполнил курсовую работу на Vue.js. To be continued…👀",
      start: "2023",
      end: "2027",
    },
    {
